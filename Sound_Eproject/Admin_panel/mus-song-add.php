...
if(isset($_POST['submit']))
{
    ...
    $query = "INSERT INTO `audio`(`audio_name`, `audio_image`, `audio_genre_id`, `audio_artist_id`, `audio_albums_id`, `audio_file`) VALUES ('$audio', '$imgname', '$genre', '$artist', '$album', '$audio_file_name')";
        ...
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
            <section class="box ">
                ...
                <div class="content-body">
                    <div class="row">
                        <form action="mus-song-add.php" enctype="multipart/form-data" method="post">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                               ...
                               ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="audio_name" class="form-control"
                                            style="font-weight: bold;" id="field-1">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="form-label" for="field-1" style="font-weight: bold;">Audio
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="desc"></span>
                                    <div class="controls">
                                        <input type="file" class="form-control" name="audio_file" id="field-5"
                                            accept="audio/*">
                                    </div>
                                </div>
