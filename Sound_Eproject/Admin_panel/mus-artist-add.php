...
if(isset($_POST['submit']))
{
    ...
    $query = "INSERT INTO `artist`( `artist_name`, `artist_image`, `artist_genre_id`) VALUES ('$artist','$imgname','$genre')";
    ...
    <section class="wrapper main-wrapper" style=''>
        ...
        <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
            <div class="page-title">
                ...
                <div class="pull-left">
                    <h1 class="title" style="color:#ffffff;">Artist</h1>
                </div>
        ...
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
            <section class="box ">
                <header class="panel_header">
                    <h2 class="title pull-left">Add Artists</h2>
                        ...
                        <form action="#" method="POST" enctype="multipart/form-data">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" value="" class="form-control" name="artist_name"
                                            id="field-1">
                                    </div>
                                </div>
                                <div class="form-group">
