            ...
            <div class="page-title">
                ...
                <div class="pull-right hidden-xs">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="mus-role.php" style="color:#ffffff;">Roles</a>
                        </li>
                        <!-- <li class="active">
                                            ...
                                            <table class="table table-bordered text-center">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <a href="mus-role-edit.php?updateId=<?php echo $data['role_id']?>"
                                                                class="btn btn-success"><i class="fa fa-pencil"></i></a>
                                                        </td>
                                                        <td> <a href="mus-role-del.php?deleteId=<?php echo $data['role_id']?>"
