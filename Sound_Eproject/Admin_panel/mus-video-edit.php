...
$query = "SELECT * FROM `video` WHERE `video_id` = '$update_id'";
$run = mysqli_query($conn, $query);
$datarun = mysqli_fetch_assoc($run);
...
move_uploaded_file($imgpath, 'data/mus-video/'.$imgname);
    ...
    // Check if the "audio_file" was uploaded
    if(isset($_FILES['vid_file']['name']) && !empty($_FILES['vid_file']['name'])){
        ...
        // Handle the case where no audio file was uploaded
        $vid_file_name = ""; // Set a default value or handle it differently
    }
   
    $query = "UPDATE `video` SET `video_title`='$video',`video_thumbnail`='$imgname',`video_genre_id`='$genre',`video_artist_id`='$artist',`video_albums_id`='$album',`video_file`='$vid_file_name' WHERE `video_id` = '$update_id'";
            ...
            <div class="page-title">
                ...
                <div class="pull-right hidden-xs">
                    <ol class="breadcrumb" style="color:#ffffff;">
                        ...
                        <li>
                            <a href="mus-video-add.php" style="color:#ffffff;">Video</a>
                        </li>
        ...
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
            <section class="box ">
                <header class="panel_header">
                    <h2 class="title pull-left">Update Video</h2>
                        ...
                        <form enctype="multipart/form-data" method="post">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="vid_title" class="form-control"
                                            value="<?php echo $datarun['video_title']?>" id="field-1" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="file" class="form-control" name="vid_img" id="field-5"
                                            value="<?php echo $datarun['video_thumbnail']?>" accept="image/*">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="form-label" for="field-1" style="font-weight: bold;">Video
                                    ...
                                    <div class="controls">
                                        <input type="file" class="form-control" name="vid_file" id="field-5"
                                            value="<?php echo $datarun['video_file']?>" accept="video/*">
                                    </div>
                                </div>
