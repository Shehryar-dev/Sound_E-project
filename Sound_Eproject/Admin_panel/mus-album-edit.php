...
$query = "SELECT * FROM `albums` WHERE `albums_id` = '$update_id'";
...
if(isset($_POST['submit']))
{
    ...
    $query = "UPDATE `albums` SET `albums_name`='$album_name',`albums_image`='$alb_img',`albums_des`='$album_des',`albums_artist_id`='$art' WHERE `albums_id` = '$update_id'";
    $run = mysqli_query($conn, $query);
}
?>
<!-- END TOPBAR -->
        ...
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
            <section class="box ">
                <header class="panel_header">
                    <h2 class="title pull-left">Update Albums</h2>
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="form-control" name="alb_name"
                                            value="<?php echo $data['albums_name']?>" id="field-1" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="file" class="form-control" name="image"
                                            value="<?php echo $data['albums_image']?>" id="field-5">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <textarea class="form-control autogrow" name="alb_des" id="field-6" cols="5"
                                            value="<?php echo $data['albums_des']?>"> </textarea>
                                    </div>
                                </div>
